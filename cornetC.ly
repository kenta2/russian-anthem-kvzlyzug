...
%{Intro%} fis2\f\fermata~fis4 r8\fermata a\f
    ...
    { | fis4 fis8. fis16 | fis4 fis8 fis | b4 a8. g16 | a4 d,8 d8
      | e4 e8. fis16 | e4 e8.\cresc fis16\! | g4 a8 b | cis4. a8 | \mark\default d4 a8. b16 | cis4 a8 a
      | fis4 fis8. gis16 | a4 fis8 fis | b4 a8. g16 | a4 d,8. d16 | gis4 gis8. gis16 | a8 a--[(\< b-- cis--])
      | \mark\default \time 4/4 d2->\f cis8( b) a b | cis4. a8 a a--[( b-- cis--]) b2-> a8( gis) fis gis | a4. fis8 fis fis[\> g a]
      | g4\! d8. g16\cresc g4 d8. g16| g4 d8 g b2 | \mark\default b2->\ff a | a4. fis8 fis2 | g-> ais4 gis8 ais | b4. b8 b2
