...
%{Intro%} a2\f\fermata~a4 r8\fermata a
    ...
    { a4 a8. (b16) | a4 fis8 fis | b4 a8. (g16) | a4 d,8  d
      | e4 e8. (fis16) | g4 g8.\cresc (a16)\! | b4 cis8 d | e4.  a,8 | \mark #1  a4 a8. (b16) | a4 cis8 a
      ...
      | b4\! g8. a16 b4\cresc g8. a16 | b4 g8 b d2 | \mark #3  d2->\ff cis4 b8 cis | d4.-- a8 a2 | b2-> %removed a weird cresc here
