...
%{Intro%} a2\f\fermata~a4 r8\fermata a\f
    ...
    { a4 a8. b16 | a4 fis8 fis | b4 a8. g16 | a4 d,8  d
      | e4 e8. fis16 | g4 g8.\cresc a16\! | b4 cis8 d | e4.  a,8 | \mark #16  a4 a8. b16 | a4 cis8 a
      | b4 cis8. b16 | cis4 fis,8 fis | b4 a8. g16 | a4 d,8. d16 | d'4 cis8. b16 | a8 cis--[(\< d-- e--])
      | \mark #17 \time 4/4 fis2->\f %every other part gets ff here
      e8(d) cis d | e4. a,8 a cis--[( d-- e--]) | d2-> cis8(b)a b| cis4. fis,8 fis a[\> b cis]
      | b4\! g8. a16 b4\cresc g8. a16 | b4 g8 b d2 | \mark #18  d2->\ff cis4 b8 cis | d4. a8 a2 | b2-> %removed a weird cresc here
      d8(cis)b cis | d4. b8 b2
      | \mark #19 d4 cis8. b16 a4 d,8. d16 |
