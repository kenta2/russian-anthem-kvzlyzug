...
%{Intro%} d2\f\fermata~d4 r8\fermata a\f
    ...
    { d4 a8. (b16) | cis4 fis,8 fis | b4 a8. (g16) | a4 d,8  d
      | e4 e8. (fis16) | g4 g8.\cresc (a16)\! | b4 cis8 d | e4. \afterGrace a,8 { \hideNotes d,1 }| \mark #1 \grace {d1 \unHideNotes } fis'4 e8. (d16) | e4 cis8 a
      | d4 cis8. (b16) | cis4 fis,8 fis | b4 a8. (g16) | a4 d,8. (d16) | d'4 cis8. (b16) | a4.\< \afterGrace r8 { \hideNotes d,1 \unHideNotes }
      | \mark #2 \time 4/4 fis'2->\ff e8(d) cis d | e4. a,8 a4 r | d2-> cis8(b)a b| cis4. fis,8 fis a[\> b cis] | d4\! b8. cis16 d4\cresc b8. cis16
