...
%{Intro%} g2\ff\fermata~g4 r8\fermata g\f
    ...
    {{ | fis4-> fis8. d16 d4.\>  g8\f}
     {f2_\markup{\italic rit.} f4\< g }} |  g2\fff\fermata~g8 r r4 \bar "|."
  }}
